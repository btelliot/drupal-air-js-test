...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        // Load data directly
        const data = await loadCSVData('https://sustainable-tourism.cms-uat.yukon.ca/github-proxy/js/data/vw_kpi_air_arrivals_ytd_summary.csv');
        ...
        const monthlyConfig = {
            ...
            dataFile: 'https://sustainable-tourism.cms-uat.yukon.ca/github-proxy/js/data/vw_kpi_air_arrivals_ytd_summary.csv'
        };
