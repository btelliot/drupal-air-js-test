...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        // Load data directly
        const data = await loadCSVData('https://raw.githubusercontent.com/btelliot/drupal-air-js-test/refs/heads/main/js/data/vw_kpi_air_arrivals_ytd_summary.csv');
        ...
        const monthlyConfig = {
            ...
            dataFile: 'https://raw.githubusercontent.com/btelliot/drupal-air-js-test/refs/heads/main/js/data/vw_kpi_air_arrivals_ytd_summary.csv'
        };
